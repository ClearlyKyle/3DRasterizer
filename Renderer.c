...
void Draw_Textured_Smooth_Shaded_Triangle(const Rendering_data *render, const __m128 v0, const __m128 v1, const __m128 v2, __m128 nrm0, __m128 nrm1, __m128 nrm2, const __m128 frag_colour, const __m128 light_direction)
{
    // used when checking if w0,w1,w2 is greater than 0;
    const __m128i fxptZero = _mm_setzero_si128();
